...
;(function (undefined) {
    ...
    SelectHandler.prototype.updateRectSelection = function () {
        ...
        if (this.options.rotationPoint) {
            if (this.options.points) {
                this.rectSelection.set.get(9).center(bbox.width / 2, OFFSET);
            } else {
                this.rectSelection.set.get(1).center(bbox.width / 2, OFFSET);
            }
        }
    };
    ...
    SelectHandler.prototype.selectRect = function (value) {
        ...
        if (this.options.rotationPoint && ((this.options.points && !this.rectSelection.set.get(9)) || (!this.options.points && !this.rectSelection.set.get(1)))) {
            ...
            this.rectSelection.set.add(this.nested.circle(this.options.radius).center(bbox.width / 2, OFFSET).attr('class', this.options.classPoints + '_rot')
